                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if (($u->status_bayar == '1' || $u->status_bayar == '2') && $u->metode_pembayaran == 'Online') {
                                            ...
                                            // echo anchor('user_santri/hapus_pemlainya/' . $u->id_pem_lainya . '/' . $u->nis . '/' . $u->order_id, '<input type=reset class="btn btn-danger" value=\'Hapus\'>');
                                        } elseif ($u->status_bayar == '0') {
                                            echo anchor('user_santri/cetak_kwitansi_pembayaran/' . $u->id_pem_lainya . '/' . $u->nis, 'Cetak', array('title' => 'Cetak Kwitansi Pembayaran', 'class' => 'btn btn-info'));
                                        }
                                        ?>
                                    </td>
                                </tr>
                                <div class="modal fade" id="updatepemlainnya" tabindex="-1" role="dialog" aria-labelledby="addNewpemLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="p-5">
                                                <form id="form-pembayaran-lainnya" class="user" method="post" action="<?= base_url('user_santri/update_bayar'); ?>" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="id" class="form-control" type="text" value="<?= $sant['nama_santri']; ?>" hidden>
