        ...
        <div class="card">
            ...
            <div class="card-content">
                <?php foreach ($santri as $u) { ?>
                    <form id="form-spp" class="form-inline" method="post" action="<?= base_url('user_santri/tambah_aksi'); ?>">
                        <input name="id" id="id" class="form-control" type="text" value="<?php echo $u->nis ?>" hidden>
