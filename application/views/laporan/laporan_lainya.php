        ...
        <div class="card-body">
            <div class="container">
                ...
                <form method="get" action="" class="form">
                    ...
                    <a href="<?php echo base_url() . "laporan/laporan_lainya"; ?>">Reset Filter</a>
                </form>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo $data->id_pem_lainya ?></td>
                                    ...
                                    <td style="text-align: center;"><?php echo 'Rp. ' . number_format($data->total_tagihan, 0, ',', '.'); ?></td>
