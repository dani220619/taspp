            ...
            <div class="col-lg">
              <div class="p-5">
                <div class="text-center">
                  ...
                  <h1 class="h4 text-gray-900 mb-4 mt-2">Login Santri</h1>
                </div>
                <?= form_error('menu', '<div class="alert alert-danger close" role="alert">', '
                                </div>') ?>
                <?= $this->session->flashdata('message7') ?>
                <form class="user" method="post" action="<?= base_url('auth/login_santri'); ?>">
                  <div class="form-group">
                    <input type="text" class="form-control form-control-user" value="<?= set_value('') ?>" name="nis" id="nis" aria-describedby="emailHelp" placeholder="Enter Nis">
                ...
                <hr>
                <div class="text-center">
                  <a class="small" href="<?= base_url('auth'); ?>">Masuk sebagai <b>ADMIN!</b></a>
                </div>
                <hr>
              </div>
            </div>
