...
where a.id= $id")->result_array();
        foreach ($query as $q) :
            ...
            $bln = $array_bln[date_format($date1, "")];
        ?>
    ...
    margin-bottom: 10px;">Segenap Panitia Mengucapkan <i>"Jazaakumullahu Khoiron Katsiiro" </i> kepada : </div>
                    ...
                    <span style="font-size:16px;color: #191919;text-align:center;padding-left:50px;padding-right:50px;display: flex;">Untuk Pembangunan Masjid Ngadirno Desa Klero Kecamatan Tengaran, semoga amalnya diterima dan mendapatkan balasan yang lebih baik dari Allah SWT, aamiin
</body></span>
...
<table style="margin-top:0px;width:30%;margin-top:15px;margin-left: 288px;float:left">
    ...
    <tr>
        <td style="text-align:center;color: #191919;font-size:16px;"><span><b>Bp. Mundakir</b></td>
    </tr>
...
<table style="margin-top:0px;width:30%;margin-top:15px;float:right;">
    ...
    <tr>
        <td style="text-align:center;color: #191919;font-size:16px;"><span><b>Zaenal Muttaqin</b></td>
    </tr>
</table>
