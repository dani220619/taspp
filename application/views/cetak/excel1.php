...
<table class="table table-hover">
    <thead>
        <tr>
            <th colspan=6 height="30px">BUKU KAS UMUM</th>
        </tr>
        <tr>
            <th colspan=6 height="30px">Pondok Pesantren Al Munawwir Komplek L Yogyakarta</th>
        </tr>
        <tr>
            <th colspan=6 height="30px">Periode Bulan : <?= date_format($date1, " F Y") ?> - <?= date_format($date2, "F Y")  ?></th>
        </tr>
