            ...
            <div class="row">
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('user/updatepassword'); ?>" enctype="multipart/form-data">
                            ...
                            <hr>
                            <input type="submit" name="submit" value="Ganti Password" class="btn btn-primary btn-user btn-block">
                        </form>
                    </div>
                </div>
            </div>
